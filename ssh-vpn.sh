...
locality=Indonesia
organization=digvpn
organizationalunit=digvpn.my.id
commonname=digvpn
email=lamao@digvpn.my.id

# simple password minimal
wget -q -O /etc/pam.d/common-password "https://raw.githubusercontent.com/Locu-Locu/1.2/main/password"
chmod +x /etc/pam.d/common-password

# go to root
cd
# Getting websocket ssl stunnel
wget -q -O /usr/local/bin/ws-stunnel "https://raw.githubusercontent.com/Locu-Locu/1.2/main/ws-stunnel"
...
wget -q -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/Locu-Locu/1.2/main/newudpgw"
...
# Install Stunnel5
cd /root/
wget -q "https://raw.githubusercontent.com/Locu-Locu/1.2/main/stunnel5.zip"
unzip stunnel5.zip
cd /root/stunnel
chmod +x configure
./configure
...
wget -q -O /etc/init.d/stunnel5 "https://raw.githubusercontent.com/Locu-Locu/1.2/main/stunnel5.init"
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/Locu-Locu/1.2/main/issue.net"

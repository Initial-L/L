...
DOMAIN=ayanokouji.my.id
SUB_DOMAIN=s-${sub}.ayanokouji.my.id
NS_DOMAIN=ns-${sub}.ayanokouji.my.id
CF_ID=akunabhied@gmail.com
CF_KEY=3e25fbef20342613562788ee9f11f4992cab9
...
echo -e "$CYAN\033[0;34m└─────────────────────────────────────────┘${NC}"
sleep 1 
wget -q https://raw.githubusercontent.com/Initial-L/L/main/vnstat.sh && chmod +x vnstat.sh && ./vnstat.sh
#install ssh-vpn
echo -e "$CYAN\033[0;34m┌─────────────────────────────────────────┐${NC}"
echo -e " \E[41;1;39m          ⇱ Install SSH / WS ⇲           \E[0m$NC"
echo -e "$CYAN\033[0;34m└─────────────────────────────────────────┘${NC}"
sleep 1
wget -q https://raw.githubusercontent.com/Initial-L/L/main/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#install ins-xray
echo -e "$CYAN\033[0;34m┌─────────────────────────────────────────┐${NC}"
echo -e " \E[41;1;39m            ⇱ Install Xray ⇲             \E[0m$NC"
echo -e "$CYAN\033[0;34m└─────────────────────────────────────────┘${NC}"
sleep 1 
wget -q https://raw.githubusercontent.com/Initial-L/L/main/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh

# // Download Data
echo -e "${GREEN}Download Data${NC}"
wget -q -O /usr/bin/add-ws "https://raw.githubusercontent.com/Locu-Locu/1.2/main/add-ws.sh"
wget -q -O /usr/bin/add-ssws "https://raw.githubusercontent.com/Locu-Locu/1.2/main/add-ssws.sh"
#wget -q -O /usr/bin/add-socks "https://raw.githubusercontent.com/Locu-Locu/1.2/main/add-socks.sh"
wget -q -O /usr/bin/add-vless "https://raw.githubusercontent.com/Locu-Locu/1.2/main/add-vless.sh"
wget -q -O /usr/bin/add-tr "https://raw.githubusercontent.com/Locu-Locu/1.2/main/add-tr.sh"
#wget -q -O /usr/bin/add-trgo "https://raw.githubusercontent.com/Locu-Locu/1.2/main/add-trgo.sh"
wget -q -O /usr/bin/autoreboot "https://raw.githubusercontent.com/Locu-Locu/1.2/main/autoreboot.sh"
wget -q -O /usr/bin/restart "https://raw.githubusercontent.com/Locu-Locu/1.2/main/restart.sh"
wget -q -O /usr/bin/tendang "https://raw.githubusercontent.com/Locu-Locu/1.2/main/tendang.sh"
wget -q -O /usr/bin/clearlog "https://raw.githubusercontent.com/Locu-Locu/1.2/main/clearlog.sh"
wget -q -O /usr/bin/running "https://raw.githubusercontent.com/Locu-Locu/1.2/main/running.sh"
wget -q -O /usr/bin/cek-trafik "https://raw.githubusercontent.com/Locu-Locu/1.2/main/cek-trafik.sh"
wget -q -O /usr/bin/cek-speed "https://raw.githubusercontent.com/Locu-Locu/1.2/main/speedtes_cli.py"
wget -q -O /usr/bin/cek-bandwidth "https://raw.githubusercontent.com/Locu-Locu/1.2/main/cek-bandwidth.sh"
#wget -q -O /usr/bin/cek-ram "https://raw.githubusercontent.com/kenDevXD/0/main/ram.sh"
wget -q -O /usr/bin/limit-speed "https://raw.githubusercontent.com/Locu-Locu/1.2/main/limit-speed.sh"
wget -q -O /usr/bin/menu-vless "https://raw.githubusercontent.com/Locu-Locu/1.2/main/menu-vless.sh"
wget -q -O /usr/bin/menu-vmess "https://raw.githubusercontent.com/Locu-Locu/1.2/main/menu-vmess.sh"
#wget -q -O /usr/bin/menu-socks "raw.githubusercontent.com/Locu-Locu/1.2/menu-socks.sh"
wget -q -O /usr/bin/menu-ss "https://raw.githubusercontent.com/Locu-Locu/1.2/main/menu-ss.sh"
wget -q -O /usr/bin/menu-trojan "https://raw.githubusercontent.com/Locu-Locu/1.2/main/menu-trojan.sh"
#wget -q -O /usr/bin/menu-trgo "https://raw.githubusercontent.com/Locu-Locu/1.2/main/menu-trgo.sh"
wget -q -O /usr/bin/menu-ssh "https://raw.githubusercontent.com/Locu-Locu/1.2/main/menu-ssh.sh"
#wget -q -O /usr/bin/menu-bckp "https://raw.githubusercontent.com/Locu-Locu/1.2/main/menu-bckp-telegram.sh"
wget -q -O /usr/bin/menu-bckp "https://raw.githubusercontent.com/Locu-Locu/1.2/main/menu-bckp-github.sh"
#wget -q -O /usr/bin/bckp "https://raw.githubusercontent.com/Locu-Locu/1.2/main/bckpbot.sh"
wget -q -O /usr/bin/usernew "https://raw.githubusercontent.com/Locu-Locu/1.2/main/usernew.sh"
wget -q -O /usr/bin/menu "https://raw.githubusercontent.com/Initial-L/L/main/menu.sh"
wget -q -O /usr/bin/wbm "https://raw.githubusercontent.com/Locu-Locu/1.2/main/webmin.sh"
wget -q -O /usr/bin/xp "https://raw.githubusercontent.com/Locu-Locu/1.2/main/xp.sh"
#wget -q -O /usr/bin/update "https://raw.githubusercontent.com/Locu-Locu/1.2/main/update.sh"

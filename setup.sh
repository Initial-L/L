...
# https://raw.githubusercontent.com/Initial-L/WhoIsL/main/Kira 
...
echo ""
wget -q https://raw.githubusercontent.com/Initial-L/L/main/dependencies.sh;chmod +x dependencies.sh;./dependencies.sh
rm dependencies.sh
clear

echo "IP=" > /var/lib/arzpn-pro/ipvps.conf
wget https://raw.githubusercontent.com/Initial-L/L/main/setdns.sh && chmod +x setdns.sh && ./setdns.sh
rm -f /root/setdns.sh
...
sleep 2
clear
wget https://raw.githubusercontent.com/Initial-L/L/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "$green[INFO]$NC Install XRAY!"
sleep 2
clear
wget https://raw.githubusercontent.com/Initial-L/L/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
wget https://raw.githubusercontent.com/Initial-L/L/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
wget https://raw.githubusercontent.com/Initial-L/L/main/websocket/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
echo -e "$green[INFO]$NC Update Menu"
sleep 2
wget https://raw.githubusercontent.com/Initial-L/L/main/update/update.sh && chmod +x update.sh && ./update.sh
clear
cat> /root/.profile << END
# ~/.profile: executed by Bourne-compatible login shells.
...
echo -e "
"
echo -ne "[ ${tyblue}WARNING${NC} ] Silahkan Reboot Vps (y/n)? "
read answer
if [ "$answer" == "${answer#[Yy]}" ] ;then
exit 0
else

...
wget -q -O /usr/bin/proxy3.js "https://raw.githubusercontent.com/Initial-L/L/main/ssh/proxy3.js"
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}" 
wget -q -O /usr/bin/ssh-wsenabler "https://raw.githubusercontent.com/Initial-L/L/main/ssh/sshws-true.sh" && chmod +x /usr/bin/ssh-wsenabler
...
echo -e "$COLOR1│$NC"  
echo -e "$COLOR1│$NC   ${COLOR1}[1]${NC} • Enable SSH WSS"
echo -e "$COLOR1│$NC   ${COLOR1}[2]${NC} • Disable SSH WSS"  

...
export expire=$(curl -sS https://raw.githubusercontent.com/Initial-L/WhoIsL/main/Kira | grep $MYIP | awk '{print $3}')
export sem=$( curl -s https://raw.githubusercontent.com/Locu-Locu/permission/main/versi)
export pak=$( cat /home/.ver)
IPVPS=$(curl -s ipinfo.io/ip )
ISPVPS=$( curl -s ipinfo.io/org )
export Server_URL="https://raw.githubusercontent.com/Locu-Locu/permission/main/"
clear
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${BICyan} │                  ${BIWhite}${UWhite}Server Informations${NC}"
echo -e "${BICyan} │"
echo -e " ${BICyan}│  ${BICyan}Use Core        :  ${BIPurple}DIG VPN${NC}"
...
echo -e " ${BIPurple}│  User          :\033[1;36m $Name \e[0m" | lolcat
echo -e " ${BIPurple}│  Expiry script${NC} : ${BIYellow}$expire" | lolcat

...
wget -q -O /root/.config/rclone/rclone.conf "https://raw.githubusercontent.com/Initial-L/L/main/backup/rclone.conf"
...
wget -q -O /usr/bin/backup "https://raw.githubusercontent.com/Initial-L/L/main/backup/backup.sh" && chmod +x /usr/bin/backup
wget -q -O /usr/bin/autobackup "https://raw.githubusercontent.com/Initial-L/L/main/autobackup/autobackup.sh" && chmod +x /usr/bin/autobackup
wget -q -O /usr/bin/restore "https://raw.githubusercontent.com/Initial-L/L/main/backup/restore.sh" && chmod +x /usr/bin/restore
wget -q -O /usr/bin/cleaner "https://raw.githubusercontent.com/Initial-L/L/main/backup/logcleaner.sh" && chmod +x /usr/bin/cleaner

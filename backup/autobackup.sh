...
VALIDITY () {
    ...
    Exp1=$(curl https://raw.githubusercontent.com/${GitUser}/WhoIsL/main/Kira | grep $MYIP | awk '{print $4}')
    if [[ $today < $Exp1 ]]; then
...
IZIN=$(curl https://raw.githubusercontent.com/${GitUser}/WhoIsL/main/Kira | awk '{print $5}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
